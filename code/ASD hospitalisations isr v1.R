...
df = dbGetQuery(con, "select * from .ccu030_20221015_1600_patient_skinny_record_enhanced27_isrs_infected")
nrow(df)
...
df = dbGetQuery(con, "select * from .ccu030_20221015_1600_patient_skinny_record_enhanced27_isrs_all")
nrow(df) 
