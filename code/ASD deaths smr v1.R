...
df = dbGetQuery(con, "select * from .ccu030_20221015_1600_patient_skinny_record_enhanced19_smrs")
nrow(df) 
...
df = dbGetQuery(con, "select * from .ccu030_20221015_1600_patient_skinny_record_enhanced18_smrs")
nrow(df) 
